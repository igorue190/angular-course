...
@Component({
  selector: 'strenth-password',
  templateUrl: './strenth-password.component.html',
  styleUrls: ['./strenth-password.component.css']
})
export class StrenthPasswordComponent implements OnInit {
